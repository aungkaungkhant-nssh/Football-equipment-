    ...
    <section className='my-4 px-4'>
     ...
     <div className='text-center mt-10 border border-white border-b-gray-200 pb-5'>
      ...
      <div className='flex justify-end my-7'>
          <button className='border  border-neutral-400 rounded-full px-4 py-2  text-neutral-700 text-sm hover:bg-neutral-900 hover:text-gray-100 transiton all duration-300 shadow-inner'>
                Remove All
          </button>
      </div>
